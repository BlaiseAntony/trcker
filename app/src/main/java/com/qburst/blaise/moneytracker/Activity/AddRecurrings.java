...
public class AddRecurrings extends AppCompatActivity implements View.OnClickListener,DatePickerDialog.OnDateSetListener {
    private int day;
    private int month;
    private int year;
    ...
    public void saveData(View view) {
        EditText intervl = findViewById(R.id.interval);
        interval = Integer.parseInt(String .valueOf(intervl.getText()));
        EditText e =findViewById(R.id.amount);
        amount = Integer.parseInt(String.valueOf(e.getText()));
        Recurring recurring = new Recurring(itemId,year,month,day,amount,interval);
        db.insertRecurring(recurring);
        onBackPressed();
    }
}
